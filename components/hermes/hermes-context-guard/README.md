...
```bash
git clone https://github.com/RedBeret/hermes-context-guard.git \
  ~/.hermes/projects/hermes-context-guard
cd ~/.hermes/projects/hermes-context-guard
bash setup.sh
```

## Requirements

- Hermes Agent v0.8.0+ (skills system)
