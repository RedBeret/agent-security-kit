---
name: context-guard
description: Proactive context management for long Hermes sessions. Prevents context degradation, manages compaction, and keeps sessions sharp. Use when sessions are getting long, the agent starts repeating itself, or the user asks about context health, compaction, session management, or token usage.
---
