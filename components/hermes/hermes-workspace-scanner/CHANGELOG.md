...
### Added
- Initial public release. 7-check workspace audit (leaked secrets, executables, double-extensions, PII, world-readable files, hardcoded paths, suspicious permissions).
