...
Thanks for your interest in claude-code-security-kit. PRs welcome — small, focused changes are easiest to review and merge quickly.

## Before you submit

1. **Run the publish-gate** (if installed): `bash scripts/publish-gate.sh .` — catches secrets, debug code, and missing docs.
