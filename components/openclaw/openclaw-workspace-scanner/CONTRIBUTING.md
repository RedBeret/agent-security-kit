...
Thanks for your interest in openclaw-workspace-scanner. PRs welcome — small, focused changes are easiest to review and merge quickly.

## Before you submit

1. **Run the publish-gate** (if installed): `bash ~/.openclaw/publish-gate.sh .` — catches secrets, debug code, and missing docs.
